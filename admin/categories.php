...
// Lấy danh sách danh mục (thêm kiểm tra lỗi truy vấn)
$sql = "SELECT id, name, created_at FROM categories ORDER BY id DESC";
$result = $conn->query($sql);

if (!$result) {
    die("<h3 style='color:red; text-align:center;'>Lỗi truy vấn SQL: " . $conn->error . "</h3>");
}
?>
<!doctype html>
<html lang="vi">
...
<div class="admin-wrapper">
  ...
  <main class="admin-main">
    <div class="admin-header">
      ...
      <a href="add_category.php" class="admin-btn">+ Thêm danh mục</a>
    </div>
